create table bookCollections (id  bigserial not null, directoryPath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, numberOfBookCollections int4 not null, numberOfBooks int4 not null, updateDate timestamp not null, number int4 not null, parentBookCollectionId int8, primary key (id));
...
create table books (id  bigserial not null, fileId varchar(64) not null, filePath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, numberOfPages int4 not null, updateDate timestamp not null, number int4 not null, bookCollectionId int8, primary key (id));
