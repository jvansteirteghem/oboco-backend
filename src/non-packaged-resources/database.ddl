create table bookCollectionMarks (id bigint generated by default as identity, createDate timestamp not null, updateDate timestamp not null, userId bigint not null, bookCollectionId bigint not null, numberOfBookPages integer not null, bookPage integer not null, primary key (id));
create table bookCollections (id bigint generated by default as identity, directoryPath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, createDate timestamp not null, updateDate timestamp not null, rootBookCollectionId bigint, parentBookCollectionId bigint, numberOfBookCollections integer not null, numberOfBooks integer not null, numberOfBookPages integer not null, number integer not null, primary key (id));
create table bookMarkReferences (id bigint generated by default as identity, bookId bigint not null, bookMarkId bigint not null, primary key (id));
