...
create table bookMarkReferences (id bigint generated by default as identity, fileId varchar(64) not null, updateDate timestamp not null, userId bigint not null, bookId bigint, bookMarkId bigint not null, rootBookCollectionId bigint not null, primary key (id));
create table bookMarks (id bigint generated by default as identity, fileId varchar(64) not null, page integer not null, updateDate timestamp not null, userId bigint not null, primary key (id));
...
create table users (id bigint generated by default as identity, name varchar(255) not null, passwordHash varchar(60) not null, updateDate timestamp not null, rootBookCollectionId bigint, primary key (id));
