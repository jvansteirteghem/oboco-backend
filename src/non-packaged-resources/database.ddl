create table bookCollectionMarks (id bigint generated by default as identity, createDate timestamp not null, updateDate timestamp not null, userId bigint not null, bookCollectionId bigint not null, numberOfPages integer not null, page integer not null, primary key (id));
create table bookCollections (id bigint generated by default as identity, directoryPath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, createDate timestamp not null, updateDate timestamp not null, rootBookCollectionId bigint, parentBookCollectionId bigint, numberOfBookCollections integer not null, numberOfBooks integer not null, number integer not null, primary key (id));
create table bookMarkReferences (id bigint generated by default as identity, createDate timestamp not null, updateDate timestamp not null, bookId bigint not null, bookMarkId bigint not null, primary key (id));
create table bookMarks (id bigint generated by default as identity, fileId varchar(64) not null, numberOfPages integer not null, page integer not null, createDate timestamp not null, updateDate timestamp not null, userId bigint not null, primary key (id));
create table books (id bigint generated by default as identity, fileId varchar(64) not null, filePath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, numberOfPages integer not null, createDate timestamp not null, updateDate timestamp not null, bookCollectionId bigint not null, rootBookCollectionId bigint not null, number integer not null, primary key (id));
create table userRoles (userId bigint not null, role varchar(255) not null);
create table users (id bigint generated by default as identity, name varchar(255) not null, passwordHash varchar(60) not null, createDate timestamp not null, updateDate timestamp not null, rootBookCollectionId bigint, primary key (id));
