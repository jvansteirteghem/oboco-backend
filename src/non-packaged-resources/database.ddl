...
create table bookMarkReferences (id bigint generated by default as identity, createDate timestamp not null, updateDate timestamp not null, userId bigint not null, bookId bigint, bookMarkId bigint not null, bookCollectionId bigint not null, rootBookCollectionId bigint not null, primary key (id));
create table bookMarks (id bigint generated by default as identity, fileId varchar(64) not null, page integer not null, createDate timestamp not null, updateDate timestamp not null, userId bigint not null, primary key (id));
