...
create table bookMarkReferences (id bigint not null auto_increment, createDate timestamp(3) not null default current_timestamp(3), updateDate timestamp(3) not null default current_timestamp(3), userId bigint not null, bookId bigint, bookMarkId bigint not null, bookCollectionId bigint not null, rootBookCollectionId bigint not null, primary key (id));
create table bookMarks (id bigint not null auto_increment, fileId varchar(64) not null, page integer not null, createDate timestamp(3) not null default current_timestamp(3), updateDate timestamp(3) not null default current_timestamp(3), userId bigint not null, primary key (id));
