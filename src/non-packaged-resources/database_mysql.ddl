create table bookCollectionMarks (id bigint not null auto_increment, createDate timestamp(3) not null default current_timestamp(3), updateDate timestamp(3) not null default current_timestamp(3), userId bigint not null, bookCollectionId bigint not null, numberOfPages integer not null, page integer not null, primary key (id));
create table bookCollections (id bigint not null auto_increment, directoryPath varchar(4096) not null, name varchar(255) not null, normalizedName varchar(255) not null, createDate timestamp(3) not null default current_timestamp(3), updateDate timestamp(3) not null default current_timestamp(3), rootBookCollectionId bigint, parentBookCollectionId bigint, numberOfBookCollections integer not null, numberOfBooks integer not null, number integer not null, primary key (id));
create table bookMarkReferences (id bigint not null auto_increment, createDate timestamp(3) not null default current_timestamp(3), updateDate timestamp(3) not null default current_timestamp(3), bookId bigint not null, bookMarkId bigint not null, primary key (id));
