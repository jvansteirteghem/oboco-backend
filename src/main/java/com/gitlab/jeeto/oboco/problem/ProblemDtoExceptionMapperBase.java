...
public abstract class ProblemDtoExceptionMapperBase implements ExceptionMapper<Throwable> {
	private static Logger logger = LoggerFactory.getLogger(ProblemDtoExceptionMapperBase.class.getName());
