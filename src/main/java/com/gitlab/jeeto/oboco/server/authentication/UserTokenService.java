...
public class UserTokenService {
	...
	public String getAccessTokenValue(String name) throws ProblemException {
		String secret = getConfiguration().getAsString("server.authentication.secret", "secret");
		Long age = getConfiguration().getAsLong("server.authentication.accessToken.age", "3600") * 1000L;
	...
	public String getRefreshTokenValue(String name) throws ProblemException {
		String secret = getConfiguration().getAsString("server.authentication.secret", "secret");
		Long age = getConfiguration().getAsLong("server.authentication.refreshToken.age", "31536000") * 1000L;
